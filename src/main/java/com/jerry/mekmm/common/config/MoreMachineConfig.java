...
public class MoreMachineConfig {
    ...
    public static final MoreMachineGeneratorsConfig generator = new MoreMachineGeneratorsConfig();
    ...
    public static void registerConfigs(ModContainer modContainer) {
        ...
        MoreMachineConfigHelper.registerConfig(modContainer, generator);
    }
}
