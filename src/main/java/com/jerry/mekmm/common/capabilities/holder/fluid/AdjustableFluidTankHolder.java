...
public class AdjustableFluidTankHolder extends BasicHolder<IExtendedFluidTank> implements IFluidTankHolder {
    ...
    protected AdjustableFluidTankHolder(Supplier<Direction> facingSupplier, @Nullable Predicate<RelativeSide> insertPredicate, @Nullable Predicate<RelativeSide> extractPredicate) {
