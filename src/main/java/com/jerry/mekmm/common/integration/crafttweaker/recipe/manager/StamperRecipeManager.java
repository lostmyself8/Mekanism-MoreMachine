...
public class StamperRecipeManager extends MekanismRecipeManager<StamperRecipe> {
     ...
     * @param mold   {@link ItemStackIngredient} representing the mold input of the recipe.
     * @param output {@link IItemStack} representing the output of the recipe.
     */
    @ZenCodeType.Method
    public void addRecipe(String name, ItemStackIngredient input, ItemStackIngredient mold, IItemStack output) {
        addRecipe(makeRecipe(getAndValidateName(name), input, mold, output));
    }
     ...
     */
    public final StamperRecipe makeRecipe(ResourceLocation id, ItemStackIngredient input, ItemStackIngredient mold, IItemStack output) {
        return new StamperIRecipe(id, input, mold, getAndValidateNotEmpty(output));
    }
