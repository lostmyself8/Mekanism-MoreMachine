...
//
// @Override
// public String dumpToCommandString(IRecipeManager<? super StamperRecipe> manager, RegistryAccess registryAccess,
// RecipeHolder<StamperRecipe> recipeHolder) {
...
//
// @Override
// public <U extends Recipe<?>> boolean doesConflict(IRecipeManager<? super StamperRecipe> manager, StamperRecipe
// recipe, U o) {
...
//
// @Override
// public Optional<IDecomposedRecipe> decompose(IRecipeManager<? super StamperRecipe> manager, RegistryAccess
// registryAccess, StamperRecipe recipe) {
// return decompose(recipe.getInput(), recipe.getMold(), recipe.getOutputDefinition());
// }
//
// @Override
// public Optional<StamperRecipe> recompose(IRecipeManager<? super StamperRecipe> m, RegistryAccess registryAccess,
