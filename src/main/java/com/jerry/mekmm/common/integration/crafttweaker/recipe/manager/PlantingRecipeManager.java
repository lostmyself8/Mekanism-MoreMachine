...
// */
// @ZenCodeType.Method
// public void addRecipe(String name, IIngredientWithAmount itemInput, ChemicalStackIngredient chemicalInput, IItemStack
// mainOutput, boolean perTickUsage) {
...
// @ZenCodeType.Method
// public void addRecipe(String name, IIngredientWithAmount itemInput, ChemicalStackIngredient chemicalInput, IItemStack
// secondaryOutput, double secondaryChance, boolean perTickUsage) {
...
// @ZenCodeType.Method
// public void addRecipe(String name, IIngredientWithAmount itemInput, ChemicalStackIngredient chemicalInput, IItemStack
// mainOutput, IItemStack secondaryOutput, double secondaryChance, boolean perTickUsage) {
...
// * @param perTickUsage Should the recipe consume the chemical input each tick it is processing.
// */
// public final PlantingRecipe makeRecipe(IIngredientWithAmount itemInput, ChemicalStackIngredient chemicalInput,
// IItemStack mainOutput, boolean perTickUsage) {
// return new BasicPlantingRecipe(CrTUtils.fromCrT(itemInput), chemicalInput, getAndValidateNotEmpty(mainOutput),
// ItemStack.EMPTY, 0, perTickUsage);
// }
//
// /**
...
// */
// public final PlantingRecipe makeRecipe(IIngredientWithAmount itemInput, ChemicalStackIngredient chemicalInput,
// IItemStack secondaryOutput, double secondaryChance, boolean perTickUsage) {
// return new BasicPlantingRecipe(CrTUtils.fromCrT(itemInput), chemicalInput, ItemStack.EMPTY,
// getAndValidateNotEmpty(secondaryOutput), getAndValidateSecondaryChance(secondaryChance), perTickUsage);
// }
//
// /**
...
// */
// public final PlantingRecipe makeRecipe(IIngredientWithAmount itemInput, ChemicalStackIngredient chemicalInput,
// IItemStack mainOutput, IItemStack secondaryOutput, double secondaryChance, boolean perTickUsage) {
// return new BasicPlantingRecipe(CrTUtils.fromCrT(itemInput), chemicalInput, getAndValidateNotEmpty(mainOutput),
// getAndValidateNotEmpty(secondaryOutput), getAndValidateSecondaryChance(secondaryChance), perTickUsage);
// }
//
...
// throw new IllegalArgumentException("This planting recipe requires a secondary output chance greater than zero and at
// most one.");
// }
