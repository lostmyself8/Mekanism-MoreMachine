...
// return new BasicRecyclerRecipe(CrTUtils.fromCrT(input), getAndValidateNotEmpty(output),
// getAndValidateChance(chance));
// }
//
// private double getAndValidateChance(double chance) {
// if (chance <= 0 || chance > 1) {
// throw new IllegalArgumentException("This recycling recipe requires a output chance greater than zero and at most
// one.");
// }
// return chance;
// }
