...
//
// @Override
// public String dumpToCommandString(IRecipeManager<? super RecyclerRecipe> manager, RegistryAccess registryAccess,
// RecipeHolder<RecyclerRecipe> recipeHolder) {
// RecyclerRecipe recipe = recipeHolder.value();
// return buildCommandString(manager, recipeHolder, recipe.getInput(), recipe.getChanceOutputDefinition(),
// recipe.getOutputChance());
// }
//
// @Override
// public <U extends Recipe<?>> boolean doesConflict(IRecipeManager<? super RecyclerRecipe> manager, RecyclerRecipe
// recipe, U o) {
// return o instanceof RecyclerRecipe other && ingredientConflicts(recipe.getInput(), other.getInput());
// }
//
// @Override
// public Optional<IDecomposedRecipe> decompose(IRecipeManager<? super RecyclerRecipe> manager, RegistryAccess
// registryAccess, RecyclerRecipe recipe) {
// return decompose(recipe.getInput(), recipe.getChanceOutputDefinition(), recipe.getOutputChance());
// }
//
// @Override
// public Optional<RecyclerRecipe> recompose(IRecipeManager<? super RecyclerRecipe> m, RegistryAccess registryAccess,
