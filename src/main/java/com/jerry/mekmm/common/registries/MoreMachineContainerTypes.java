...
public class MoreMachineContainerTypes {
    ...
    public static final ContainerTypeRegistryObject<MekanismTileContainer<TileEntityWirelessChargingStation>> WIRELESS_CHARGING_STATION = MM_CONTAINER_TYPES.custom(MoreMachineBlocks.WIRELESS_CHARGING_STATION, TileEntityWirelessChargingStation.class).offset(0, 0).build();
