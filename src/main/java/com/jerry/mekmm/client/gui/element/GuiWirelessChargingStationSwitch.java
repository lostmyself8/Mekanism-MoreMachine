...
public class GuiWirelessChargingStationSwitch extends GuiTexturedElement {
    ...
    public GuiWirelessChargingStationSwitch(IGuiWrapper gui, int x, int y, ResourceLocation icon, BooleanSupplier stateSupplier, Component tooltip, Runnable onToggle, SwitchType type) {
