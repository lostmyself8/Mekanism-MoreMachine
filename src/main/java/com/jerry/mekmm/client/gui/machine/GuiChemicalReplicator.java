...
public class GuiChemicalReplicator extends GuiConfigurableTile<TileEntityChemicalReplicator, MekanismTileContainer<TileEntityChemicalReplicator>> {
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(new GuiChemicalGauge(() -> tile.inputTank, tile::getChemicalTanks, GaugeType.STANDARD, this, 28, 4))
        ...
        addRenderableWidget(new GuiChemicalGauge(() -> tile.outputTank, tile::getChemicalTanks, GaugeType.STANDARD, this, 131, 4))
