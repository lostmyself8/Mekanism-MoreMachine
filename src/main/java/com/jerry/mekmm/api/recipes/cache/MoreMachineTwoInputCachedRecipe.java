...
public class MoreMachineTwoInputCachedRecipe<HOLDER_A, INPUT_A extends TypedInstance<HOLDER_A>, HOLDER_B, INPUT_B extends TypedInstance<HOLDER_B>, OUTPUT, RECIPE extends MekanismRecipe<?> & BiPredicate<INPUT_A, INPUT_B>> extends CachedRecipe<RECIPE> {
    ...
    protected final Supplier<? extends InputIngredient<HOLDER_A, INPUT_A>> inputSupplier;
     ...
     */
    protected MoreMachineTwoInputCachedRecipe(RECIPE recipe, BooleanSupplier recheckAllErrors, IInputHandler<HOLDER_A, INPUT_A> inputHandler, IInputHandler<HOLDER_B, INPUT_B> secondaryInputHandler,
