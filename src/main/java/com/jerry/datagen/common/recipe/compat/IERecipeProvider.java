...
// new ItemStack(IEItems.Metals.PLATES.get(EnumMetals.GOLD))).addCondition(modLoaded).build(consumer, Mekmm.rl(basePath
// + "stamper/gold_plate"));
//
// StamperRecipeBuilder.stamping(
// IngredientCreatorAccess.item().from(Tags.Items.INGOTS_COPPER),
// IngredientCreatorAccess.item().from(IEItems.Molds.MOLD_PLATE),
// new ItemStack(IEItems.Metals.PLATES.get(EnumMetals.COPPER))).addCondition(modLoaded).build(consumer,
// Mekmm.rl(basePath + "stamper/copper_plate"));
//
// StamperRecipeBuilder.stamping(
// IngredientCreatorAccess.item().from(Tags.Items.INGOTS_IRON),
// IngredientCreatorAccess.item().from(IEItems.Molds.MOLD_PLATE),
// new ItemStack(IEItems.Metals.PLATES.get(EnumMetals.IRON))).addCondition(modLoaded).build(consumer, Mekmm.rl(basePath
// + "stamper/iron_plate"));
//
// StamperRecipeBuilder.stamping(
// IngredientCreatorAccess.item().from(Tags.Items.INGOTS_IRON),
// IngredientCreatorAccess.item().from(IEItems.Molds.MOLD_ROD),
// new ItemStack(IEItems.Ingredients.STICK_IRON, 2)).addCondition(modLoaded).build(consumer, Mekmm.rl(basePath +
// "stamper/iron_stick"));
//
// StamperRecipeBuilder.stamping(
// IngredientCreatorAccess.item().from(Tags.Items.INGOTS_NETHERITE),
// IngredientCreatorAccess.item().from(IEItems.Molds.MOLD_ROD),
// new ItemStack(IEItems.Ingredients.STICK_NETHERITE, 2)).addCondition(modLoaded).build(consumer, Mekmm.rl(basePath +
// "stamper/netherite_stick"));
//
// StamperRecipeBuilder.stamping(
// IngredientCreatorAccess.item().from(Tags.Items.INGOTS_COPPER),
// IngredientCreatorAccess.item().from(IEItems.Molds.MOLD_BULLET_CASING),
// new ItemStack(IEItems.Ingredients.EMPTY_CASING, 2)).addCondition(modLoaded).build(consumer, Mekmm.rl(basePath +
// "stamper/empty_casing"));
//
// StamperRecipeBuilder.stamping(
// IngredientCreatorAccess.item().from(Tags.Items.INGOTS_COPPER),
// IngredientCreatorAccess.item().from(IEItems.Molds.MOLD_WIRE),
// new ItemStack(IEItems.Ingredients.WIRE_COPPER, 2)).addCondition(modLoaded).build(consumer, Mekmm.rl(basePath +
// "stamper/copper_wire"));
//
// StamperRecipeBuilder.stamping(
