...
public class ModelSolarHeatGenerator extends MekanismJavaModel {
    ...
    private static final ModelPartData ports_1 = new ModelPartData("ports_1", CubeListBuilder.create()
            .texOffs(46, 371).addBox(-5.0F, -29.0F, -56.0F, 10.0F, 10.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(316, 374).addBox(-20.0F, -28.0F, -56.0F, 8.0F, 8.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(316, 374).addBox(12.0F, -28.0F, -56.0F, 8.0F, 8.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(46, 371).addBox(-5.0F, -13.0F, -56.0F, 10.0F, 10.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(352, 374).addBox(12.0F, -12.0F, -56.0F, 8.0F, 8.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(352, 374).addBox(-20.0F, -12.0F, -56.0F, 8.0F, 8.0F, 1.0F, new CubeDeformation(0.0F)),
            PartPose.offset(0.0F, 0.0F, 0.0F));

    private static final ModelPartData ports_2 = new ModelPartData("ports_2", CubeListBuilder.create()
            .texOffs(334, 374).addBox(-20.0F, -12.0F, -56.0F, 8.0F, 8.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(334, 374).addBox(12.0F, -12.0F, -56.0F, 8.0F, 8.0F, 1.0F, new CubeDeformation(0.0F)),
    ...
    private static final ModelPartData base_connector = new ModelPartData("base_connector", CubeListBuilder.create()
            .texOffs(272, 283).addBox(-24.0F, -32.0F, -55.0F, 48.0F, 32.0F, 7.0F, new CubeDeformation(0.0F))
            .texOffs(0, 283).addBox(-24.0F, -32.0F, -48.0F, 48.0F, 24.0F, 16.0F, new CubeDeformation(0.0F)),
            PartPose.offset(0.0F, 0.0F, 0.0F));

    private static final ModelPartData base_connector_r3 = new ModelPartData("base_connector_r3", CubeListBuilder.create()
            .texOffs(320, 104).addBox(-23.0F, -8.0F, -12.0F, 46.0F, 11.0F, 12.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(-7.5F, 0.0F, 34.0F, -0.3927F, 0.0F, 0.0F));

    private static final ModelPartData keyboard_r1 = new ModelPartData("keyboard_r1", CubeListBuilder.create()
            .texOffs(324, 248).addBox(-7.0F, -3.2F, -5.0F, 14.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(-7.5F, -4.0F, 37.0F, -0.3927F, 0.0F, 0.0F));

    private static final ModelPartData screen_connector_r1 = new ModelPartData("screen_connector_r1", CubeListBuilder.create()
            .texOffs(92, 371).addBox(0.0F, -7.0F, 0.0F, 12.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(284, 363).addBox(0.5F, -10.0F, 1.0F, 14.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(1.0F, -10.0F, 31.5F, 0.0F, -0.3927F, 0.0F));

    private static final ModelPartData screen_connector_r2 = new ModelPartData("screen_connector_r2", CubeListBuilder.create()
            .texOffs(364, 253).addBox(-12.0F, -7.0F, 0.0F, 12.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(284, 363).addBox(-14.5F, -10.0F, 1.0F, 14.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(-16.0F, -10.0F, 31.5F, 0.0F, 0.3927F, 0.0F));

    private static final ModelPartData controller = new ModelPartData("controller", CubeListBuilder.create()
            .texOffs(284, 363).addBox(-14.5F, -20.0F, 32.5F, 14.0F, 10.0F, 2.0F, new CubeDeformation(0.0F))
            .texOffs(258, 299).addBox(-10.0F, -13.0F, 31.5F, 5.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(364, 248).addBox(-16.0F, -17.0F, 31.5F, 17.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
            .texOffs(48, 348).addBox(-31.5F, -8.0F, 34.0F, 16.0F, 16.0F, 7.0F, new CubeDeformation(0.0F))
            .texOffs(48, 348).mirror().addBox(0.5F, -8.0F, 34.0F, 16.0F, 16.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false)
            .texOffs(208, 363).addBox(-15.5F, -5.0F, 34.0F, 16.0F, 13.0F, 6.0F, new CubeDeformation(0.0F))
            .texOffs(128, 318).addBox(-31.5F, -24.0F, 23.0F, 48.0F, 24.0F, 7.0F, new CubeDeformation(0.0F))
            .texOffs(128, 299).addBox(-31.5F, -26.0F, 23.0F, 48.0F, 2.0F, 17.0F, new CubeDeformation(0.0F)),
            PartPose.offset(7.5F, -8.0F, 14.0F), base_connector_r3, keyboard_r1, screen_connector_r1, screen_connector_r2);
    ...
    private static final ModelPartData tube_a = new ModelPartData("tube_a", CubeListBuilder.create()
            .texOffs(252, 363).addBox(14.0F, -2.0F, -32.0F, 4.0F, 2.0F, 12.0F, new CubeDeformation(0.0F))
            .texOffs(272, 248).addBox(18.0F, -2.0F, -24.0F, 22.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
            .texOffs(68, 371).addBox(40.0F, -2.0F, -24.0F, 8.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
            .texOffs(376, 182).addBox(44.0F, 2.0F, -24.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)),
            PartPose.offset(0.0F, 0.0F, 0.0F));

    private static final ModelPartData tube_a2 = new ModelPartData("tube_a2", CubeListBuilder.create()
            .texOffs(252, 363).mirror().addBox(-18.0F, -2.0F, -32.0F, 4.0F, 2.0F, 12.0F, new CubeDeformation(0.0F)).mirror(false)
            .texOffs(272, 248).mirror().addBox(-40.0F, -2.0F, -24.0F, 22.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
            .texOffs(68, 371).mirror().addBox(-48.0F, -2.0F, -24.0F, 8.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
            .texOffs(376, 182).mirror().addBox(-48.0F, 2.0F, -24.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
            PartPose.offset(0.0F, 0.0F, 0.0F));
    ...
    private static final ModelPartData tube_b = new ModelPartData("tube_b", CubeListBuilder.create()
            ...
            .texOffs(376, 192).addBox(40.0F, 2.0F, 20.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)),
            PartPose.offset(0.0F, 0.0F, 0.0F));
    ...
    private static final ModelPartData tube_b2 = new ModelPartData("tube_b2", CubeListBuilder.create()
            ...
            .texOffs(376, 192).mirror().addBox(-44.0F, 2.0F, 20.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
            PartPose.offset(0.0F, 0.0F, 0.0F));

    private static final ModelPartData handle = new ModelPartData("handle", CubeListBuilder.create()
            .texOffs(370, 374).addBox(-30.0F, -1.0F, 19.0F, 1.0F, 1.0F, 8.0F, new CubeDeformation(0.0F))
            .texOffs(370, 374).addBox(-17.0F, -1.0F, 19.0F, 1.0F, 1.0F, 8.0F, new CubeDeformation(0.0F))
            .texOffs(370, 374).mirror().addBox(29.0F, -1.0F, 19.0F, 1.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false)
            .texOffs(370, 374).mirror().addBox(16.0F, -1.0F, 19.0F, 1.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false),
            PartPose.offset(0.0F, 0.0F, 0.0F));

    private static final ModelPartData MIDDLE = new ModelPartData("middle", CubeListBuilder.create()
            .texOffs(0, 323).addBox(-3.0F, -3.0F, -32.0F, 6.0F, 3.0F, 20.0F, new CubeDeformation(0.0F))
            .texOffs(320, 161).addBox(-10.0F, -1.0F, 13.0F, 20.0F, 1.0F, 20.0F, new CubeDeformation(0.0F)),
    ...
    private static final ModelPartData panel_r1 = new ModelPartData("panel_r1", CubeListBuilder.create()
    ...
    private static final ModelPartData panel_r2 = new ModelPartData("panel_r2", CubeListBuilder.create()
    ...
    private static final ModelPartData panel_a = new ModelPartData("panel_a", CubeListBuilder.create(),
            PartPose.offset(0.0F, -48.0F, 0.0F), panel_r1, panel_r2);

    private static final ModelPartData panel_r3 = new ModelPartData("panel_r3", CubeListBuilder.create()
            .texOffs(264, 258).addBox(-55.0F, 39.0F, -11.0F, 110.0F, 3.0F, 22.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(0.0F, 2.0F, 0.0F, 1.0472F, 0.0F, 0.0F));

    private static final ModelPartData panel_r4 = new ModelPartData("panel_r4", CubeListBuilder.create()
            .texOffs(0, 229).addBox(-55.01F, 39.0F, -15.0F, 110.0F, 3.0F, 26.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(0.0F, 2.0F, 0.0F, 0.5236F, 0.0F, 0.0F));

    private static final ModelPartData panel_b = new ModelPartData("panel_b", CubeListBuilder.create(),
            PartPose.offset(0.0F, -48.0F, 0.0F), panel_r3, panel_r4);
    ...
    private static final ModelPartData TOP = new ModelPartData("top", CubeListBuilder.create()
            ...
            PartPose.offset(0.0F, -40.0F, 0.0F), tube_supports, panel_a, panel_b, panel_supports);
