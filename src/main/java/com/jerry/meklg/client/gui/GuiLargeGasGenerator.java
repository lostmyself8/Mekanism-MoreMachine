...
public class GuiLargeGasGenerator extends GuiMekanismTile<TileEntityLargeGasBurningGenerator, MekanismTileContainer<TileEntityLargeGasBurningGenerator>> {

    public GuiLargeGasGenerator(MekanismTileContainer<TileEntityLargeGasBurningGenerator> container, Inventory inv, Component title) {
