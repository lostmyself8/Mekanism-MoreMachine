...
public class GuiLargeWindGenerator extends GuiMekanismTile<TileEntityLargeWindGenerator, MekanismTileContainer<TileEntityLargeWindGenerator>> {
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(new GuiInnerScreen(this, 48, 21, 80, 44, () -> {
            ...
            list.add(GeneratorsLang.POWER.translate(MekanismUtils.convertToDisplay(MoreMachineConfig.generator.largeWindGenerationMin.get()
            ...
            if (!tile.getActive()) {
                ILangEntry reason = tile.isBlacklistDimension() ? GeneratorsLang.NO_WIND : tile.hasSameGeneratorNearby() ? MoreMachineLang.SAME_BLOCK_NEARBY : GeneratorsLang.SKY_BLOCKED;
        ...
        addRenderableWidget(new GuiEnergyTab(this, () -> List.of(GeneratorsLang.PRODUCING_AMOUNT.translate(
                tile.getActive() ? EnergyDisplay.of(MoreMachineConfig.generator.largeWindGenerationMin.get().multiply(tile.getCurrentMultiplier())) : EnergyDisplay.ZERO),
