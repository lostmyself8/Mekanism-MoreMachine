...
public class LargeGeneratorContainerTypes {
    ...
    public static final ContainerTypeRegistryObject<MekanismTileContainer<TileEntitySolarHeatGenerator>> SOLAR_HEAT_GENERATOR = LG_CONTAINER_TYPES.custom(LargeGeneratorBlocks.SOLAR_HEAT_GENERATOR, TileEntitySolarHeatGenerator.class).offset(14, 3).armorSideBar(-20, 11, 0).build();
}
