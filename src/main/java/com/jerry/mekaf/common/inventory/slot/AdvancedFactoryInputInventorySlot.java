...
public class AdvancedFactoryInputInventorySlot extends InputInventorySlot {
    ...
    public static AdvancedFactoryInputInventorySlot create(TileEntityItemToPigmentFactory<?> factory, int process, IPigmentTank outputTank, @Nullable IContentsListener listener, int x, int y) {
    ...
    private AdvancedFactoryInputInventorySlot(TileEntityItemToPigmentFactory<?> factory, int process, IPigmentTank outputTank, @Nullable IContentsListener listener, int x, int y) {
    ...
    private AdvancedFactoryInputInventorySlot(TileEntityItemToItemAdvancedFactory<?> factory, int process, IInventorySlot outputSlot, @Nullable IContentsListener listener, int x, int y) {
        super(stack -> factory.inputProducesOutput(process, stack, outputSlot, false),
                factory::isValidInputItem, listener, x, y);
    }
