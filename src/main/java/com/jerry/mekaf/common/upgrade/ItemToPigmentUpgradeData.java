...
public class ItemToPigmentUpgradeData implements IUpgradeData {
    ...
    public final List<IPigmentTank> outputTanks;
    public final CompoundTag components;

    public ItemToPigmentUpgradeData(boolean redstone, RedstoneControl controlType,
                                    IEnergyContainer energyContainer, int operatingTicks, EnergyInventorySlot energySlot,
                                    InputInventorySlot inputSlot, IPigmentTank outputTank, List<ITileComponent> components) {
    ...
    public ItemToPigmentUpgradeData(boolean redstone, RedstoneControl controlType,
                                    ...
                                    List<IInventorySlot> inputSlots, List<IPigmentTank> outputTanks, boolean sorting, List<ITileComponent> components) {
