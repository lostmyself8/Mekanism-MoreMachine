...
public class AdvancedFactoryTileEntityTypes {
    ...
    static {
        for (FactoryTier tier : EnumUtils.FACTORY_TIERS) {
            ...
            FACTORIES.put(tier, AdvancedFactoryType.PIGMENT_EXTRACTING, AF_TILE_ENTITY_TYPES.register(AdvancedFactoryBlocks.getAdvancedFactory(tier, AdvancedFactoryType.PIGMENT_EXTRACTING), (pos, state) -> new TileEntityPigmentExtractingFactory(AdvancedFactoryBlocks.getAdvancedFactory(tier, AdvancedFactoryType.PIGMENT_EXTRACTING), pos, state), TileEntityMekanism::tickServer, TileEntityMekanism::tickClient));
            FACTORIES.put(tier, AdvancedFactoryType.PAINTING, AF_TILE_ENTITY_TYPES.register(AdvancedFactoryBlocks.getAdvancedFactory(tier, AdvancedFactoryType.PAINTING), (pos, state) -> new TileEntityPaintingFactory(AdvancedFactoryBlocks.getAdvancedFactory(tier, AdvancedFactoryType.PAINTING), pos, state), TileEntityMekanism::tickServer, TileEntityMekanism::tickClient));
        }
    }
