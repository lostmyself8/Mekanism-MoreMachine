...
public class ComputerMethodRegistry_mekaf implements IComputerMethodRegistry {
    ...
    public void register() {
        ...
        FactoryRegistry.register(TileEntityItemToItemAdvancedFactory.class, TileEntityItemToItemAdvancedFactory$ComputerHandler::new, TileEntityUpdateable.class, CapabilityTileEntity.class, TileEntityMekanism.class, TileEntityConfigurableMachine.class, TileEntityAdvancedFactoryBase.class);
        FactoryRegistry.register(TileEntityPaintingFactory.class, TileEntityPaintingFactory$ComputerHandler::new, TileEntityUpdateable.class, CapabilityTileEntity.class, TileEntityMekanism.class, TileEntityConfigurableMachine.class, TileEntityAdvancedFactoryBase.class, TileEntityItemToItemAdvancedFactory.class);
        ...
        FactoryRegistry.register(TileEntityWashingFactory.class, TileEntityWashingFactory$ComputerHandler::new, TileEntityUpdateable.class, CapabilityTileEntity.class, TileEntityMekanism.class, TileEntityConfigurableMachine.class, TileEntityAdvancedFactoryBase.class, TileEntityChemicalToChemicalFactory.class);
        ...
        FactoryRegistry.register(TileEntityDissolvingFactory.class, TileEntityDissolvingFactory$ComputerHandler::new, TileEntityUpdateable.class, CapabilityTileEntity.class, TileEntityMekanism.class, TileEntityConfigurableMachine.class, TileEntityAdvancedFactoryBase.class, TileEntityItemToChemicalFactory.class);
