...
public class WindGeneratorHolidayInfo extends BaseHolidayInfo {
    ...
    private WindGeneratorHolidayInfo() {}
    ...
    public static void onStitch(TextureAtlasStitchedEvent event) {
        ...
        HOLIDAY_MINER_TRANSFORMS = Map.of(
                AprilFools.INSTANCE, QuadTransformation.list(
                        ...
                        TextureFilteredTransformation.of(suffixTexture(atlas, Mekmm.rl("block/large_machine/large_wind_generator/screen_"), "afd_text"), IS_SECOND)),
