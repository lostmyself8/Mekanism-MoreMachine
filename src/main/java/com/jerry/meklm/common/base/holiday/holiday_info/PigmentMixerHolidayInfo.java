    ...
    public static void onStitch(TextureAtlasStitchedEvent event) {
        ...
        HOLIDAY_MINER_TRANSFORMS = Map.of(
                AprilFools.INSTANCE, QuadTransformation.list(
                        QuadTransformation.TextureFilteredTransformation.of(suffixTexture(atlas, Mekanism.rl("block/models/digital_miner_screen_"), "afd_sad"), IS_FIRST.or(IS_THIRD)),
                        QuadTransformation.TextureFilteredTransformation.of(suffixTexture(atlas, Mekmm.rl("block/large_machine/large_pigment_mixer/screen_"), "afd_text"), IS_SECOND)),
