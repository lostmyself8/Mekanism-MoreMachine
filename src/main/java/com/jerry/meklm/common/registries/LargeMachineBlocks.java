...
public class LargeMachineBlocks {
    ...
    public static final BlockRegistryObject<BlockTileModel<TileEntityLargePigmentMixer, Machine<TileEntityLargePigmentMixer>>, ItemBlockMachine> LARGE_PIGMENT_MIXER = LM_BLOCKS.register("large_pigment_mixer", () -> new BlockTileModel<>(LargeMachineBlockTypes.LARGE_PIGMENT_MIXER, properties -> properties.mapColor(MapColor.METAL)), ItemBlockMachine::new);
