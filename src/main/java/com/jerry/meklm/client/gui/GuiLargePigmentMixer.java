...
public class GuiLargePigmentMixer extends GuiConfigurableTile<TileEntityLargePigmentMixer, MekanismTileContainer<TileEntityLargePigmentMixer>> {
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(new GuiProgress(tile::getActive, ProgressType.SMALL_RIGHT, this, 47, 39).jeiCategories(MekanismJEIRecipeType.PIGMENT_MIXING).colored(new LeftColorDetails()))
        ...
        addRenderableWidget(new GuiProgress(tile::getActive, ProgressType.SMALL_LEFT, this, 101, 39).jeiCategories(MekanismJEIRecipeType.PIGMENT_MIXING).colored(new RightColorDetails()))
                .warning(WarningTracker.WarningType.INPUT_DOESNT_PRODUCE_OUTPUT, tile.getWarningCheck(CachedRecipe.OperationTracker.RecipeError.INPUT_DOESNT_PRODUCE_OUTPUT));
    }
