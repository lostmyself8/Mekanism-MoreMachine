...
public class GuiLargeChemicalInfuser extends GuiConfigurableTile<TileEntityLargeChemicalInfuser, MekanismTileContainer<TileEntityLargeChemicalInfuser>> {
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(new GuiProgress(tile::getActive, ProgressType.SMALL_RIGHT, this, 47, 39).jeiCategories(MekanismJEIRecipeType.CHEMICAL_INFUSING))
                .warning(WarningType.INPUT_DOESNT_PRODUCE_OUTPUT, tile.getWarningCheck(RecipeError.INPUT_DOESNT_PRODUCE_OUTPUT));
        addRenderableWidget(new GuiProgress(tile::getActive, ProgressType.SMALL_LEFT, this, 101, 39).jeiCategories(MekanismJEIRecipeType.CHEMICAL_INFUSING))
                .warning(WarningType.INPUT_DOESNT_PRODUCE_OUTPUT, tile.getWarningCheck(RecipeError.INPUT_DOESNT_PRODUCE_OUTPUT));
    }
