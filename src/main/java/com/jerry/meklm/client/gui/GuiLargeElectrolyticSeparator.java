...
public class GuiLargeElectrolyticSeparator extends GuiMekanismTile<TileEntityLargeElectrolyticSeparator, MekanismTileContainer<TileEntityLargeElectrolyticSeparator>> {
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(new GuiGasGauge(() -> tile.leftTank, () -> tile.getGasTanks(null), GaugeType.SMALL, this, 58, 18))
                .warning(WarningType.NO_SPACE_IN_OUTPUT, tile.getWarningCheck(TileEntityLargeElectrolyticSeparator.NOT_ENOUGH_SPACE_LEFT_OUTPUT_ERROR));
        addRenderableWidget(new GuiGasGauge(() -> tile.rightTank, () -> tile.getGasTanks(null), GaugeType.SMALL, this, 100, 18))
                .warning(WarningType.NO_SPACE_IN_OUTPUT, tile.getWarningCheck(TileEntityLargeElectrolyticSeparator.NOT_ENOUGH_SPACE_RIGHT_OUTPUT_ERROR));
        ...
        addRenderableWidget(new GuiProgress(tile::getActive, ProgressType.BI, this, 80, 30).jeiCategories(MekanismJEIRecipeType.SEPARATING))
