...
public class LargePigmentMixerBakedModel extends TransformedBakedModel<Void> {

    public LargePigmentMixerBakedModel(BakedModel original) {
    ...
    protected QuadsKey<Void> createKey(QuadsKey<Void> key, ModelData data) {
        QuadTransformation holidayTransform = PigmentMixerHolidayInfo.getTransform();
    ...
    @Override
    protected LargePigmentMixerBakedModel wrapModel(BakedModel model) {
        return new LargePigmentMixerBakedModel(model);
    }
}
